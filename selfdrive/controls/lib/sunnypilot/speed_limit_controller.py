...
class SpeedLimitController:
  ...
  def _update_calculations(self):
    ...
    self._v_cruise_rounded = round(self._v_cruise_setpoint * self._ms_to_local)
    self._v_cruise_prev_rounded = round(self._v_cruise_setpoint_prev * self._ms_to_local)
    self._speed_limit_offsetted_rounded = round((self._speed_limit + self.speed_limit_offset) * self._ms_to_local)
    self._speed_limit_warning_offsetted_rounded = round((self._speed_limit + self.speed_limit_warning_offset) * self._ms_to_local)
